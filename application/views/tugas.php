        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2>Data Tugas Pegawai [ <?php echo $this->M_tugas->getLabelPeriode() ?> ]
                        ...
                        <div class="card-header bg-light">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <a target="_blank" href="<?php echo base_url('tugas/pdf') ?>" class="btn btn-warning"><i class="fa fa-file-pdf-o"></i></a>

                                </div>
                                <div class="col-md-4">
                                    <form action="<?php echo base_url('tugas/filter') ?>" method="POST">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="data" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach( $get_tugas->result() as $row ){ ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            ...
                                            <?php if( $this->session->userdata('edit') == 'on' ){ ?>
                                            <td><a onclick="return confirm('Apakah anda yakin untuk menghapus baris ini ?')" href="<?php echo base_url('tugas/hapusTugas/'.$row->kode_tugas.'') ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                            <?php } ?>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
...
<div class="modal fade" id="tambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo base_url('tugas/tambahTugas') ?>">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tgl_tugas" class="form-control" required="" />
                </div>
                ...
                <div class="form-group">
                    <label class="require">Kategori Kota</label> 
                    <br>                 
                    <input type="radio" name="kategori" value="Luar Kota" checked="" >Luar Kota
                    <input type="radio" name="kategori" value="Dalam Kota" >Dalam Kota
                </div>

                <div class="form-group">
                    <label class="require">Tempat</label>                  
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('input[name="tgl_tugas"]').daterangepicker();
